...
public class WallManager : MonoBehaviour
{
    #region Variables
    // Wall Variables
    //[Header("Wall Variables")] [SerializeField]
    public WallDirection wallDirection;
    [Range(-7, 8)]
    [SerializeField]
    public int enteranceOffset = 0;
    [HideInInspector]
    [Range(3, 9)] // not current used. Would be used if enterance size was set to proceedurally generate
    ...
    {
        // Delete old
        gameObject.DestroyAllChildrenNow(geometrySpawner);
        gameObject.DestroyAllChildrenNow(enteranceSpawnPoint.gameObject);
